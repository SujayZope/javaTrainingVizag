...
public class MenuDAOImpl implements MenuDAO {
	...
	public Integer searchByMenuDao(String itemName,int restid) {
		SessionFactory sf = SessionHelper.getConnection();
		Session session = sf.openSession();
		Criteria cr = session.createCriteria(Menu.class);
...
//		System.out.println(menu);
	...
	public void menuLocaleCodeChanged(ValueChangeEvent e){
		...
		int restId = (Integer)sessionMap.get("restaurantId");
		System.out.println("Restaurant Id new   " +restId);
		Integer rid = searchByMenuDao(rname,restId);
		System.out.println("Menu Id is New " +rid);
		this.menuId = rid;
